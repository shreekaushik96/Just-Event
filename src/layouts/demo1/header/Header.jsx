...
const Header = () => {
  ...
  return <header className={clsx('header fixed top-0 z-10 start-0 end-0 flex items-stretch shrink-0 bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark] border-b', headerSticky && 'shadow-sm')}>
